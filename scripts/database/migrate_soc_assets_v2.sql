-- ============================================================================
-- AI-miniSOC 数据库表更新脚本 (ALTER TABLE版本)
-- ============================================================================
-- 功能：更新现有soc_assets和soc_asset_ports表结构
-- 版本：v1.2
-- 日期：2026-03-18
--
-- 适用场景：数据库中已存在soc_assets和soc_asset_ports表
-- 操作类型：增量更新（ALTER TABLE）
-- ============================================================================
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE soc_assets ADD COLUMN wazuh_agent_id VARCHAR(255) UNIQUE;
...
-- ============================================================================
-- 6. 迁移现有数据（从asset_description到name）
-- ============================================================================
