...
ALTER TABLE soc_assets ADD CONSTRAINT soc_assets_data_classification_check CHECK (((data_classification)::text = ANY ((ARRAY['public'::character varying, 'internal'::character varying, 'confidential'::character varying, 'secret'::character varying])::text[])));
