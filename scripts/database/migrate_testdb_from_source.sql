...
ALTER TABLE soc_assets ADD CONSTRAINT soc_assets_criticality_check CHECK (((criticality)::text = ANY ((ARRAY['critical'::character varying, 'high'::character varying, 'medium'::character varying, 'low'::character varying])::text[])));
