...
```
192.168.0.128 (本机 - E2E Testing Platform)
├── 前端开发服务器: http://192.168.0.128:5173
├── 后端API服务: http://192.168.0.128:8000
└── GitHub Actions Runner (待安装)

192.168.0.42 (测试数据库服务器)
├── PostgreSQL: 192.168.0.42:5432/AI-miniSOC-testdb
└── 测试数据: 用户、角色、菜单等
```
